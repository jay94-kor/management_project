...
if st.session_state['logged_in']:
    ...
    st.sidebar.title("메뉴")
    page = st.sidebar.selectbox("페이지 선택", ["홈", "프로젝트 입력", "프로젝트 목록", "프로젝트 예산 관리", "대시보드", "요청 및 승인 시스템", "회원 관리" if user_role == 'admin' else None, "항목별 예산 이동", "프로젝트 간 예산 이동", "담당자 지정", "마진율 유지"])
    logout()
